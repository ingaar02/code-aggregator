...
class ProjectCard(ctk.CTkFrame):
    def __init__(self, parent, project, on_click, on_delete, **kwargs):
        ...
        self.name_label = ctk.CTkLabel(
            self.text_frame, text=project.name,
        ...
        self.stack_label = ctk.CTkLabel(
            self.text_frame, text=stack,
            font=ctk.CTkFont(size=11), text_color="#858585", anchor="w"
        )
...
class Sidebar(ctk.CTkFrame):
    def __init__(self, parent, on_project_select, on_project_create, on_project_delete, **kwargs):
